...
def test_update():
    ...
    assert updated_row[5] == 5, "Update did not change the incidents_00_14 value correctly"
...
def test_delete():
    ...
    assert not any(row[0] == "Airline B" for row in result), "Deleted airline still found in the table"