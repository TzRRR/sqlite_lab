...
def create(airline, avail_seat_km_per_week, incidents_85_99, fatal_accidents_85_99, fatalities_85_99, incidents_00_14, fatal_accidents_00_14, fatalities_00_14, db_name="AirlineDB.db"):
    """Insert a new row into the AirlineDB table"""
    conn = sqlite3.connect(db_name)
    cursor = conn.cursor()
    cursor.execute("""
        INSERT INTO AirlineDB (airline, avail_seat_km_per_week, incidents_85_99, fatal_accidents_85_99, fatalities_85_99, incidents_00_14, fatal_accidents_00_14, fatalities_00_14)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)
...
# Update: Update a row in the AirlineDB table based on the airline name
...
# Delete: Delete a row in the AirlineDB table based on the airline name
